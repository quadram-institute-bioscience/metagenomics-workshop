...
```
tax_profiles/metaphlan4/ERR2231567.profile.txt
tax_profiles/metaphlan4/ERR2231568.profile.txt
tax_profiles/metaphlan4/ERR2231569.profile.txt
tax_profiles/metaphlan4/ERR2231570.profile.txt
tax_profiles/metaphlan4/ERR2231571.profile.txt
tax_profiles/metaphlan4/ERR2231572.profile.txt
```

**Option 2: Bracken profiles**
```
tax_profiles/Bracken/ERR2231567_profiles.txt
tax_profiles/Bracken/ERR2231568_profiles.txt
tax_profiles/Bracken/ERR2231569_profiles.txt
tax_profiles/Bracken/ERR2231570_profiles.txt
tax_profiles/Bracken/ERR2231571_profiles.txt
tax_profiles/Bracken/ERR2231572_profiles.txt
```

**How to download:**
1. Open file browser on notebook (top-left)
2. Navigate to `tax_profiles/metaphlan4/` or `tax_profiles/Bracken/`
...
**Where to look:** Results tab → Top of Sankey diagram
...
**Where to look:** Sample tab → Select ERR2231572 → Family level → Bar chart
...
**Where to look:** Sample tab → Family level → Compare both samples
...
**Where to look:** Sample tab → Genus level → Switch through samples OR Sample Browser tab
...
**Where to look:** Sample tab → Genus level → Search for "Lactiplantibacillus" in each sample

---

#### Question 6 (Bonus): Proteobacteria Dynamics
**What happens to Proteobacteria (phylum level) during fermentation?**

**Where to look:** Sample tab → Phylum level → Track across all samples
